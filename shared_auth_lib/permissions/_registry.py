...
ALL_PERMISSIONS: tuple[PermissionDef, ...] = (
    # auth
    _d(auth.AUTH_SYSTEM_ADMIN, "Full system administration"),
    _d(auth.AUTH_AUDIT_READ, "Read audit logs"),
    ...
    _d(auth.AUTH_CREDENTIAL_READ, "Read credentials"),
    _d(auth.AUTH_CREDENTIAL_UPDATE, "Update credentials"),
    _d(auth.AUTH_CREDENTIAL_DELETE, "Delete credentials"),
    _d(auth.AUTH_CREDENTIAL_READ_SECRET, "Read credential secret values"),
    _d(auth.AUTH_CREDENTIAL_TYPE_CREATE, "Create credential types"),
